...
.method public varargs doInBackground([Ljava/lang/Object;)Ljava/lang/Void;
    ...
    :try_start_0
    iget-object v6, p0, Landroid/widget/ActivityChooserModel$PersistHistoryAsyncTask;->this$0:Landroid/widget/ActivityChooserModel;
    ...
    .line 1079
    const-string/jumbo v7, "historical-records"
    ...
    check-cast v9, Landroid/widget/ActivityChooserModel$HistoricalRecord;

    .line 1084
    .local v9, "record":Landroid/widget/ActivityChooserModel$HistoricalRecord;
    const-string/jumbo v10, "historical-record"
    ...
    iget-object v11, v9, Landroid/widget/ActivityChooserModel$HistoricalRecord;->activity:Landroid/content/ComponentName;
    ...
    iget-wide v11, v9, Landroid/widget/ActivityChooserModel$HistoricalRecord;->time:J
    ...
    iget v11, v9, Landroid/widget/ActivityChooserModel$HistoricalRecord;->weight:F
    ...
    .line 1082
    .end local v9    # "record":Landroid/widget/ActivityChooserModel$HistoricalRecord;
    ...
    invoke-static {v0, v2}, Landroid/widget/ActivityChooserModel;->access$602(Landroid/widget/ActivityChooserModel;Z)Z
    ...
    const-string v9, "Error writing historical recrod file: "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v9, p0, Landroid/widget/ActivityChooserModel$PersistHistoryAsyncTask;->this$0:Landroid/widget/ActivityChooserModel;

    invoke-static {v9}, Landroid/widget/ActivityChooserModel;->access$500(Landroid/widget/ActivityChooserModel;)Ljava/lang/String;
    ...
    .line 1108
    :goto_3
    iget-object v4, p0, Landroid/widget/ActivityChooserModel$PersistHistoryAsyncTask;->this$0:Landroid/widget/ActivityChooserModel;

    invoke-static {v4, v2}, Landroid/widget/ActivityChooserModel;->access$602(Landroid/widget/ActivityChooserModel;Z)Z
    ...
    const-string v7, "Error writing historical recrod file: "
