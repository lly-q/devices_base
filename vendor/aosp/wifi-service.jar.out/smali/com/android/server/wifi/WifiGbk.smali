...
.method public static getGbkBytes(Ljava/lang/String;)[B
    ...
    invoke-static {p0, v1}, Lcom/android/server/wifi/WifiGbk;->getSsidBytes(Ljava/lang/String;Ljava/lang/String;)[B
    ...
    const-string v4, "No valid gbkBytes for ssid="
    ...
    const-string v3, "Exceed max length 48, ssid="
...
.method public static getUtfBytes(Ljava/lang/String;)[B
    .locals 4
    .param p0, "SSID"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    const-string v3, "No valid utfBytes for ssid="
