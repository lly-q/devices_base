...
.method private processReceivedAwarePeerMacAddresses(Lcom/android/server/wifi/rtt/RttServiceImpl$RttRequestInfo;Ljava/util/Map;)V
    ...
    iget-object v5, v3, Landroid/net/wifi/rtt/ResponderConfig;->peerHandle:Landroid/net/wifi/aware/PeerHandle;

    iget v5, v5, Landroid/net/wifi/aware/PeerHandle;->peerId:I
    ...
    iget-object v7, v3, Landroid/net/wifi/rtt/ResponderConfig;->peerHandle:Landroid/net/wifi/aware/PeerHandle;

    iget v8, v3, Landroid/net/wifi/rtt/ResponderConfig;->responderType:I

    iget-boolean v9, v3, Landroid/net/wifi/rtt/ResponderConfig;->supports80211mc:Z

    iget v10, v3, Landroid/net/wifi/rtt/ResponderConfig;->channelWidth:I

    iget v11, v3, Landroid/net/wifi/rtt/ResponderConfig;->frequency:I

    iget v12, v3, Landroid/net/wifi/rtt/ResponderConfig;->centerFreq0:I

    iget v13, v3, Landroid/net/wifi/rtt/ResponderConfig;->centerFreq1:I

    iget v14, v3, Landroid/net/wifi/rtt/ResponderConfig;->preamble:I

    move-object v5, v4

    invoke-direct/range {v5 .. v14}, Landroid/net/wifi/rtt/ResponderConfig;-><init>(Landroid/net/MacAddress;Landroid/net/wifi/aware/PeerHandle;IZIIIII)V

    .line 1019
    invoke-virtual {v1, v4}, Landroid/net/wifi/rtt/RangingRequest$Builder;->addResponder(Landroid/net/wifi/rtt/ResponderConfig;)Landroid/net/wifi/rtt/RangingRequest$Builder;
