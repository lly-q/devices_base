...
.field protected mTimeZoneIdOfCapitalCity:[[Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/internal/telephony/GsmCdmaPhone;Lcom/android/internal/telephony/TimeServiceHelper;Lcom/android/internal/telephony/NitzStateMachine$DeviceState;Lcom/android/internal/telephony/TimeZoneLookupHelper;)V
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/NitzStateMachine;->mTimeLog:Landroid/util/LocalLog;
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/NitzStateMachine;->mTimeZoneLog:Landroid/util/LocalLog;
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/NitzStateMachine;->mTimeZoneIdOfCapitalCity:[[Ljava/lang/String;
    ...
    const-string v3, "NitzStateMachine"

    invoke-virtual {v2, v1, v3}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v1

    iput-object v1, p0, Lcom/android/internal/telephony/NitzStateMachine;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    invoke-virtual {v1, v3}, Lcom/android/internal/telephony/TimeServiceHelper;->setListener(Lcom/android/internal/telephony/TimeServiceHelper$Listener;)V
...
.method private updateTimeZoneByNetworkCountryCode(Ljava/lang/String;)V
    ...
    iget-boolean v1, v0, Lcom/android/internal/telephony/TimeZoneLookupHelper$CountryResult;->allZonesHaveSameOffset:Z
    ...
    .line 686
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/NitzStateMachine;->getTimeZonesWithCapitalCity(Ljava/lang/String;)Ljava/util/TimeZone;
    ...
    const-string v4, "updateTimeZoneByNetworkCountryCode: set special countries iso="
    ...
    const-string v4, "updateTimeZoneByNetworkCountryCode: no good zone for iso="
...
.method private updateTimeZoneByNetworkCountryCodeOP(Ljava/lang/String;Ljava/lang/String;)V
    .locals 4
    .param p1, "iso"    # Ljava/lang/String;
    ...
    const-string v3, "OPIpTime: updateTimeZoneByNetworkCountryCodeOP() set time lookupResult="
    ...
    .line 711
    iget-object v1, v0, Lcom/android/internal/telephony/TimeZoneLookupHelper$CountryResult;->zoneId:Ljava/lang/String;
    ...
    const-string v3, "OPIpTime: updateTimeZoneByNetworkCountryCodeOP() no good zone for iso="
    ...
    .line 714
    invoke-direct {p0, p2}, Lcom/android/internal/telephony/NitzStateMachine;->setAndBroadcastNetworkSetTimeZone(Ljava/lang/String;)V
...
.method protected getTimeZonesWithCapitalCity(Ljava/lang/String;)Ljava/util/TimeZone;
    .locals 6
    .param p1, "iso"    # Ljava/lang/String;
    ...
    .local v2, "i":I
    :goto_0
    iget-object v3, p0, Lcom/android/internal/telephony/NitzStateMachine;->mTimeZoneIdOfCapitalCity:[[Ljava/lang/String;
    ...
    .line 751
    iget-object v1, p0, Lcom/android/internal/telephony/NitzStateMachine;->mTimeZoneIdOfCapitalCity:[[Ljava/lang/String;
    ...
    const-string v5, "uses TimeZone of Capital City:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v5, p0, Lcom/android/internal/telephony/NitzStateMachine;->mTimeZoneIdOfCapitalCity:[[Ljava/lang/String;
...
.method public handleAutoTimeZoneEnabledOP(Ljava/lang/String;)V
    .locals 4
    ...
    const-string v2, "OPIpTime: handleAutoTimeZoneEnabledOP() Reverting to NITZ mSavedTimeZoneId = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v2, p0, Lcom/android/internal/telephony/NitzStateMachine;->mSavedTimeZoneId:Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/NitzStateMachine;->setAndBroadcastNetworkSetTimeZone(Ljava/lang/String;)V

    goto :goto_0

    .line 617
    :cond_0
    iget-object v0, p0, Lcom/android/internal/telephony/NitzStateMachine;->mDeviceState:Lcom/android/internal/telephony/NitzStateMachine$DeviceState;
    ...
    const-string v3, "OPIpTime: handleAutoTimeZoneEnabledOP() iso = "
    ...
    .line 621
    invoke-direct {p0, v0, p1}, Lcom/android/internal/telephony/NitzStateMachine;->updateTimeZoneByNetworkCountryCodeOP(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    .line 625
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/NitzStateMachine;->setAndBroadcastNetworkSetTimeZone(Ljava/lang/String;)V
