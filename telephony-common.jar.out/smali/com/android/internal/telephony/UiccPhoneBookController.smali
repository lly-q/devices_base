...
.method public getAdnEventState()I
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/UiccPhoneBookController;->getAdnEventStateForSubscriber(I)I
...
.method public getAdnEventStateForSubscriber(I)I
    .locals 4
    .param p1, "subId"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .line 183
    invoke-virtual {v0}, Lcom/android/internal/telephony/IccPhoneBookInterfaceManager;->getAdnEventState()I
    ...
    const-string v3, "getAdnEventStateForSubscriber iccPbkIntMgr is null for Subscription:"
