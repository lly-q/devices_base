...
.method public calculateAndReportScoreExt(Landroid/net/wifi/WifiInfo;Landroid/net/NetworkAgent;Lcom/android/server/wifi/WifiMetrics;Z)V
    .locals 18
    .param p1, "wifiInfo"    # Landroid/net/wifi/WifiInfo;
    .param p2, "networkAgent"    # Landroid/net/NetworkAgent;
    .param p3, "wifiMetrics"    # Lcom/android/server/wifi/WifiMetrics;
    .param p4, "autoSwitchToMobileData"    # Z
    ...
    invoke-virtual {v0, v9, v12, v13}, Lcom/android/server/wifi/ConnectedScore;->updateUsingWifiInfo(Landroid/net/wifi/WifiInfo;J)V

    .line 175
    iget-object v0, v8, Lcom/android/server/wifi/WifiScoreReport;->mVelocityBasedConnectedScore:Lcom/android/server/wifi/VelocityBasedConnectedScore;

    invoke-virtual {v0, v9, v12, v13}, Lcom/android/server/wifi/VelocityBasedConnectedScore;->updateUsingWifiInfo(Landroid/net/wifi/WifiInfo;J)V
    ...
    .line 186
    iget-boolean v1, v8, Lcom/android/server/wifi/WifiScoreReport;->mVerboseLoggingEnabled:Z
    ...
    const-string v4, "new wifi score: "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v0}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v4, " ,wifiInfo.txSuccessRate="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-wide v4, v9, Landroid/net/wifi/WifiInfo;->txSuccessRate:D

    invoke-virtual {v3, v4, v5}, Ljava/lang/StringBuilder;->append(D)Ljava/lang/StringBuilder;

    const-string v4, " wifiInfo.rxSuccessRate="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-wide v4, v9, Landroid/net/wifi/WifiInfo;->rxSuccessRate:D
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/wifi/ScoringParams;->getExitRssi(I)I
    ...
    .line 206
    :cond_3
    iget-boolean v2, v8, Lcom/android/server/wifi/WifiScoreReport;->mVerboseLoggingEnabled:Z
    ...
    const-string v4, " ,getFilteredRssi= "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v4, v8, Lcom/android/server/wifi/WifiScoreReport;->mVelocityBasedConnectedScore:Lcom/android/server/wifi/VelocityBasedConnectedScore;

    invoke-virtual {v4}, Lcom/android/server/wifi/VelocityBasedConnectedScore;->getFilteredRssi()D

    move-result-wide v4

    invoke-virtual {v3, v4, v5}, Ljava/lang/StringBuilder;->append(D)Ljava/lang/StringBuilder;

    const-string v4, " wifiInfo.getRssi="
    ...
    const-string v3, " autoSwitchToMobileData: "
